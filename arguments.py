...
def build_parser():
    ...
    psr.add_argument('--channel_loss_weight', type=float, default=1.0,
                     help="Channel loss weight")

    psr.add_argument('--xor_loss_weight', type=float, default=1.0,
                     help="XOR loss weight")

    psr.add_argument('--check_iter', type=int, default=500,
                     help=("Interval of iterations "
                           "to save model and images"))
    ...
    psr.add_argument('--wb_project', type=str, default=None,
                     help="Proejct Name for wandb")
